    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <img
          src={VeeandPhilPhoto}
          alt="Vee and Phil"
          className="absolute inset-0 w-full h-full object-cover object-center opacity-[0.16] scale-105 brightness-[1.02] contrast-[0.98]"
        />

        {/* Subtle theme color ambient glows */}
        <div className="absolute top-0 -left-20 w-96 h-96 bg-[#8B1E3F]/10 rounded-full blur-3xl" />

        <div className="absolute bottom-10 -right-20 w-96 h-96 bg-[#002147]/10 rounded-full blur-3xl" />
        ...
        {/* Passport Guilloche Security Pattern */}
        <div
          className="absolute inset-0 opacity-[0.035]"
          style={{
            backgroundImage:
              'radial-gradient(#8B1E3F 1px, transparent 1px), radial-gradient(#002147 1px, #FCFAF7 1px)',
        ...
        <div className="absolute inset-0 bg-gradient-radial from-transparent via-[#FCFAF7]/50 to-[#FCFAF7]" />
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col items-center text-center max-w-4xl pt-6">
        ...
        <div className="relative mb-6">
          ...
          >
            <div className="w-28 sm:w-32 h-28 sm:h-32 rounded-full border-2 border-dashed border-[#8B1E3F]/80 p-1 flex items-center justify-center shadow-sm bg-white/40 backdrop-blur-[1px]">
              <div className="w-full h-full rounded-full border border-[#8B1E3F]/70 flex flex-col items-center justify-center p-2 text-center text-[#8B1E3F]">
                ...
                <span className="text-[7px] tracking-[0.2em] font-bold uppercase font-sans">
                  REPUBLIC OF LOVE
                </span>

                <span className="text-[10px] font-serif font-black tracking-widest my-0.5">
                  ENTRY VISA
                </span>

                <span className="text-[8px] font-mono font-bold tracking-tight bg-[#8B1E3F]/10 px-1.5 py-0.5 rounded">
                  25 OCT 2026
                </span>

                <span className="text-[7px] tracking-wider uppercase font-sans mt-0.5">
                  NAIROBI • KENYA
                </span>

                <span className="text-[6px] tracking-widest text-emerald-700 font-bold uppercase mt-0.5">
                  ★ APPROVED ★
                </span>
        ...
        >
          ...
          <span className="font-semibold">
            {WEDDING_DETAILS.couple.featureHeadline}
          </span>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm sm:text-base text-[#D4AF37] font-serif italic my-1 font-bold">
            &amp;
          </p>
        ...
        >
          <span className="block mb-1 md:inline md:mb-0 text-[#8B1E3F] font-semibold drop-shadow-sm">
            {WEDDING_DETAILS.couple.bride}
          </span>

          <span className="font-serif text-[#D4AF37] mx-3 text-3xl sm:text-4xl md:text-5xl italic font-normal">
            &amp;
          </span>

          <span className="block mt-1 md:inline md:mt-0 text-[#002147] font-semibold drop-shadow-sm">
        ...
        >
          ...
          <span className="text-[#8B1E3F]">
            #{WEDDING_DETAILS.couple.nickname}
          </span>
        ...
        >
          <p className="mb-1.5 leading-relaxed">
            “{WEDDING_DETAILS.bibleVerses[0].text}”
          </p>
        ...
        <motion.div
          ...
          className="w-full max-w-xl bg-white/90 backdrop-blur-sm border-2 border-dashed border-[#D4AF37]/60 rounded-xl p-3.5 select-none text-left overflow-x-auto shadow-sm"
        >
          ...
          <div className="font-mono text-[10px] sm:text-[11px] leading-tight text-stone-700 tracking-[0.22em] sm:tracking-[0.28em] whitespace-nowrap font-medium">
            ...
            <p>
              VP202610254KEN9610258F2610254ARAKA&lt;PHILEMON02
            </p>
          </div>
        </motion.div>
      </div>
